...
'
' ===============================================================================
Namespace SmartPay.NAPS.SQLSeverDAL
...
#Region "ExecuteNonQuery"
        ...
        ' Parameters:
        ' -connectionstringPay - a valid connection string for a SqlConnection
        ' -commandType - the CommandType (stored procedure, text, etc.)
        ' -commandText - the stored procedure name or T-SQL command
        ' Returns: An int representing the number of rows affected by the command
        Public Overloads Shared Function ExecuteNonQuery(ByVal connectionstringPay As String, _
                                                       ByVal commandType As CommandType, _
                                                       ByVal commandText As String) As Integer
            ' Pass through the call providing null for the set of SqlParameters
            Return ExecuteNonQuery(connectionstringPay, commandType, commandText, CType(Nothing, SqlParameter()))
        ...
        Public Overloads Shared Function ExecuteNonQuery(ByVal connectionstringPay As String, _
            ...
            If (connectionstringPay Is Nothing OrElse connectionstringPay.Length = 0) Then Throw New ArgumentNullException("connectionstringPay")
            ' Create & open a SqlConnection, and dispose of it after we are done
            Dim connection As SqlConnection
            Try
                connection = New SqlConnection(connectionstringPay)
                connection.Open()
        ...
        Public Overloads Shared Function ExecuteNonQuery(ByVal connectionstringPay As String, _
            ...
            If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
                ...
                commandParameters = SqlHelperParameterCache.GetSpParameterSet(connectionstringPay, spName)

                ' Assign the provided values to these parameters based on parameter order
                AssignParameterValues(commandParameters, parameterValues)

                ' Call the overload that takes an array of SqlParameters
                Return ExecuteNonQuery(connectionstringPay, CommandType.StoredProcedure, spName, commandParameters)
                ' Otherwise we can just call the SP without params
            Else
                Return ExecuteNonQuery(connectionstringPay, CommandType.StoredProcedure, spName)
            End If
        End Function ' ExecuteNonQuery
...
#Region "ExecuteDataset"
        ...
        Public Overloads Shared Function ExecuteDataset(ByVal connectionstringPay As String, _
                                                        ByVal commandType As CommandType, _
                                                        ByVal commandText As String) As DataSet
            ' Pass through the call providing null for the set of SqlParameters
            Return ExecuteDataset(connectionstringPay, commandType, commandText, CType(Nothing, SqlParameter()))
        ...
        Public Overloads Shared Function ExecuteDataset(ByVal connectionstringPay As String, _
            ...
            If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
                ...
                ' Call the overload that takes an array of SqlParameters
                Return ExecuteDataset(connectionstringPay, CommandType.StoredProcedure, spName, commandParameters)
            Else ' Otherwise we can just call the SP without params
                Return ExecuteDataset(connectionstringPay, CommandType.StoredProcedure, spName)
            End If
        End Function ' ExecuteDataset
...
#Region "ExecuteReader"
        ...
        Public Overloads Shared Function ExecuteReader(ByVal connectionstringPay As String, _
                                                       ByVal commandType As CommandType, _
                                                       ByVal commandText As String) As SqlDataReader
            ' Pass through the call providing null for the set of SqlParameters
            Return ExecuteReader(connectionstringPay, commandType, commandText, CType(Nothing, SqlParameter()))
        End Function ' ExecuteReader
        ...
        Public Overloads Shared Function ExecuteReader(ByVal connectionstringPay As String, _
            ...
            If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
                ...
                ' Call the overload that takes an array of SqlParameters
                Return ExecuteReader(connectionstringPay, CommandType.StoredProcedure, spName, commandParameters)
                ' Otherwise we can just call the SP without params
            Else
                Return ExecuteReader(connectionstringPay, CommandType.StoredProcedure, spName)
            End If
        End Function ' ExecuteReader
...
#Region "ExecuteScalar"
        ...
        Public Overloads Shared Function ExecuteScalar(ByVal connectionstringPay As String, _
                                                       ByVal commandType As CommandType, _
                                                       ByVal commandText As String) As Object
            ' Pass through the call providing null for the set of SqlParameters
            Return ExecuteScalar(connectionstringPay, commandType, commandText, CType(Nothing, SqlParameter()))
        ...
        Public Overloads Shared Function ExecuteScalar(ByVal connectionstringPay As String, _
            ...
            If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
                ...
                ' Call the overload that takes an array of SqlParameters
                Return ExecuteScalar(connectionstringPay, CommandType.StoredProcedure, spName, commandParameters)
                ' Otherwise we can just call the SP without params
            Else
                Return ExecuteScalar(connectionstringPay, CommandType.StoredProcedure, spName)
            End If
        End Function ' ExecuteScalar
...
#Region "FillDataset"
        ...
        Public Overloads Shared Sub FillDataset(ByVal connectionstringPay As String, ByVal commandType As CommandType, ByVal commandText As String, ByVal dataSet As DataSet, ByVal tableNames() As String)
        ...
        '               by a user defined name (probably the actual table name)
        ' -commandParameters: An array of SqlParamters used to execute the command
        Public Overloads Shared Sub FillDataset(ByVal connectionstringPay As String, ByVal commandType As CommandType, ByVal commandText As String, ByVal dataSet As DataSet, _
        ...
        '             by a user defined name (probably the actual table name)
        ' -parameterValues: An array of objects to be assigned As the input values of the stored procedure
        Public Overloads Shared Sub FillDataset(ByVal connectionstringPay As String, ByVal spName As String, _
...
#Region "ExecuteNonQueryTypedParams"
        ...
        Public Overloads Shared Function ExecuteNonQueryTypedParams(ByVal connectionstringPay As String, ByVal spName As String, ByVal dataRow As DataRow) As Integer
            If (connectionstringPay Is Nothing OrElse connectionstringPay.Length = 0) Then Throw New ArgumentNullException("connectionstringPay")
            If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
            ...
            If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
                ...
                ' Pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
                Dim commandParameters() As SqlParameter = SqlHelperParameterCache.GetSpParameterSet(connectionstringPay, spName)

                ' Set the parameters values
                AssignParameterValues(commandParameters, dataRow)

                ExecuteNonQueryTypedParams = SqlHelper.ExecuteNonQuery(connectionstringPay, CommandType.StoredProcedure, spName, commandParameters)
            Else
                ExecuteNonQueryTypedParams = SqlHelper.ExecuteNonQuery(connectionstringPay, CommandType.StoredProcedure, spName)
            End If
        End Function
...
#Region "ExecuteDatasetTypedParams"
        ...
        Public Overloads Shared Function ExecuteDatasetTypedParams(ByVal connectionstringPay As String, ByVal spName As String, ByVal dataRow As DataRow) As DataSet
            If (connectionstringPay Is Nothing OrElse connectionstringPay.Length = 0) Then Throw New ArgumentNullException("connectionstringPay")
            If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
            ...
            If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
                ...
                ExecuteDatasetTypedParams = SqlHelper.ExecuteDataset(connectionstringPay, CommandType.StoredProcedure, spName, commandParameters)
            Else

                ExecuteDatasetTypedParams = SqlHelper.ExecuteDataset(connectionstringPay, CommandType.StoredProcedure, spName)
            End If
        End Function
...
#Region "ExecuteReaderTypedParams"
        ...
        Public Overloads Shared Function ExecuteReaderTypedParams(ByVal connectionstringPay As String, ByVal spName As String, ByVal dataRow As DataRow) As SqlDataReader
            If (connectionstringPay Is Nothing OrElse connectionstringPay.Length = 0) Then Throw New ArgumentNullException("connectionstringPay")
            If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
            ...
            If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
                ...
                ExecuteReaderTypedParams = SqlHelper.ExecuteReader(connectionstringPay, CommandType.StoredProcedure, spName, commandParameters)
            Else
                ExecuteReaderTypedParams = SqlHelper.ExecuteReader(connectionstringPay, CommandType.StoredProcedure, spName)
            End If
        End Function
...
#Region "ExecuteScalarTypedParams"
        ...
        Public Overloads Shared Function ExecuteScalarTypedParams(ByVal connectionstringPay As String, ByVal spName As String, ByVal dataRow As DataRow) As Object
            If (connectionstringPay Is Nothing OrElse connectionstringPay.Length = 0) Then Throw New ArgumentNullException("connectionstringPay")
            If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
            ' If the row has values, the store procedure parameters must be initialized
            If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
                ...
                ExecuteScalarTypedParams = SqlHelper.ExecuteScalar(connectionstringPay, CommandType.StoredProcedure, spName, commandParameters)
            Else
                ExecuteScalarTypedParams = SqlHelper.ExecuteScalar(connectionstringPay, CommandType.StoredProcedure, spName)
            End If
        End Function
...
#Region "caching functions"
        ...
        Public Shared Sub CacheParameterSet(ByVal connectionstringPay As String, _
                                            ByVal commandText As String, _
                                            ByVal ParamArray commandParameters() As SqlParameter)
            If (connectionstringPay Is Nothing OrElse connectionstringPay.Length = 0) Then Throw New ArgumentNullException("connectionstringPay")
            If (commandText Is Nothing OrElse commandText.Length = 0) Then Throw New ArgumentNullException("commandText")

            Dim hashKey As String = connectionstringPay + ":" + commandText
        ...
        Public Shared Function GetCachedParameterSet(ByVal connectionstringPay As String, ByVal commandText As String) As SqlParameter()
            If (connectionstringPay Is Nothing OrElse connectionstringPay.Length = 0) Then Throw New ArgumentNullException("connectionstringPay")
            If (commandText Is Nothing OrElse commandText.Length = 0) Then Throw New ArgumentNullException("commandText")
...
#Region "Parameter Discovery Functions"
        ...
        Public Overloads Shared Function GetSpParameterSet(ByVal connectionstringPay As String, ByVal spName As String) As SqlParameter()
            Return GetSpParameterSet(connectionstringPay, spName, False)
        ...
        ' Returns: An array of SqlParameters 
        Public Overloads Shared Function GetSpParameterSet(ByVal connectionstringPay As String, _
                                                           ByVal spName As String, _
