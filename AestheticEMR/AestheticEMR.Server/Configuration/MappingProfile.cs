...
namespace AestheticEMR.Server.Configuration
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<VwhRecord, VwhRecordSummaryVM>()
                .ForMember(d => d.RecDate, map => map.MapFrom(s => s.RecDate))
                .ForMember(d => d.ConsultId, map => map.MapFrom(s => s.ConsultId))
                ...
                .ForMember(d => d.NextApptDate, map => map.MapFrom(s => s.NextApptDate))
                .ForMember(d => d.Htime, map => map.MapFrom(s => s.Htime))
                .ForMember(d => d.AttendedTo, map => map.MapFrom(s => s.AttendedTo))
                .ForMember(d => d.Referal, map => map.MapFrom(s => s.Referal))
                .ForMember(d => d.DocAssigned, map => map.MapFrom(s => s.DocAssigned))
                .ForMember(d => d.AttendedToByDoc, map => map.MapFrom(s => s.AttendedToByDoc))
                .ForMember(d => d.PatVal, map => map.MapFrom(s => s.PatVal))
                .ForMember(d => d.Suppres, map => map.MapFrom(s => s.Suppres))
                .ForMember(d => d.ExitDate, map => map.MapFrom(s => s.ExitDate))
                .ForMember(d => d.ExitDateComment, map => map.MapFrom(s => s.ExitDateComment))
                .ForMember(d => d.Diagnosis, map => map.MapFrom(s => s.Diagnosis))
                .ForMember(d => d.Coyname, map => map.MapFrom(s => s.Coyname))
                .ForMember(d => d.BillDate, map => map.MapFrom(s => s.BillDate))
                .ForMember(d => d.RetainCode, map => map.MapFrom(s => s.RetainCode))
                .ForMember(d => d.RetainName, map => map.MapFrom(s => s.RetainName))
                .ForMember(d => d.ClientCatId, map => map.MapFrom(s => s.ClientCatId))
                .ForMember(d => d.ClientType, map => map.MapFrom(s => s.ClientType))
                .ForMember(d => d.Fullname, map => map.MapFrom(s => s.Fullname))
                .ForMember(d => d.AcctId, map => map.MapFrom(s => s.AcctId))
                .ForMember(d => d.Dob, map => map.MapFrom(s => s.Dob))
                .ForMember(d => d.Sex, map => map.MapFrom(s => s.Sex))
                .ForMember(d => d.Age, map => map.MapFrom(s => s.Age))
                .ForMember(d => d.MonthName, map => map.MapFrom(s => s.MonthName))
                .ForMember(d => d.RetainId, map => map.MapFrom(s => s.RetainId))
                .ForMember(d => d.RegAmount, map => map.MapFrom(s => s.RegAmount))
                .ForMember(d => d.ConAmount, map => map.MapFrom(s => s.ConAmount))
                .ForMember(d => d.CardRenewAmount, map => map.MapFrom(s => s.CardRenewAmount))
                .ForMember(d => d.CoyType, map => map.MapFrom(s => s.CoyType))
                .ForMember(d => d.PCatId, map => map.MapFrom(s => s.PCatId))
                .ForMember(d => d.ClientCatId2, map => map.MapFrom(s => s.ClientCatId2))
                .ForMember(d => d.OldpNo, map => map.MapFrom(s => s.OldpNo))
                .ForMember(d => d.PhoneNo, map => map.MapFrom(s => s.PhoneNo))
                .ForMember(d => d.Debt, map => map.MapFrom(s => s.Debt))
                .ForMember(d => d.PolicyType, map => map.MapFrom(s => s.PolicyType))
                .ForMember(d => d.EmpNo, map => map.MapFrom(s => s.EmpNo))
                .ForMember(d => d.PatientPhotoBase64, map => map.Ignore());
