...
public class IncomeAccountLookup
{
...
public class IncomeBatchSaveRequest
{
    public string? TranId { get; set; }
    public List<IncomeEntry> Entries { get; set; } = new();
}

public class IncomeBatchSaveResult
{
    public List<IncomeEntry> Entries { get; set; } = new();
}

public class IncomeTranIdResult
{
...
public class PagedIncomeResult
{
    ...
    public List<IncomeListItem> Items { get; set; } = new();
}
