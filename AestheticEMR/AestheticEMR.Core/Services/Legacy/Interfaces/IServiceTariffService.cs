...
public interface IServiceTariffService
{
    ...
    IEnumerable<VwCoyAndNhi> GetCompaniesWithTariffs();
    ...
    Task<int> UploadAsync(string coyId, Stream fileStream, string fileName, bool deleteExisting, string? category = null);
