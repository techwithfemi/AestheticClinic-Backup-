...
export class OdontogramDialogComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, public dialogRef: MatDialogRef<OdontogramDialogComponent>, @Inject(MAT_DIALOG_DATA) public data: any) {
    this.form = this.fb.group({
      ...
      inflammationOfGingiva: ['', Validators.maxLength(100)],
      presenceOfDebris: ['', Validators.maxLength(100)],
      presenceOfCalculus: ['', Validators.maxLength(100)],
      presenceOfStains: ['', Validators.maxLength(100)],
      underOrthodonticTreatment: ['', Validators.maxLength(100)],
      ...
      // Child UL
      culi1: [false], culi2: [false], culc: [false],
      culpm1: [false], culpm2: [false],
      // Child UR
      curi1: [false], curi2: [false], curc: [false],
      curpm1: [false], curpm2: [false],
      // Child LL
      clli1: [false], clli2: [false], cllc: [false],
      cllpm1: [false], cllpm2: [false],
      // Child LR
      clri1: [false], clri2: [false], clrc: [false],
      clrpm1: [false], clrpm2: [false],
      // Remarks
      aRem: [''],
      cRem: [''],
    });
